...
void iBlock::rotateCW() {
	...
	if (cells[0]->getRow() != cells[1]->getRow()) {
		...
		if (isLegalCell(cells.at(1)->getRow() - 1, cells.at(1)->getCol() - 1) && isLegalCell(cells.at(2)->getRow() - 2, cells.at(2)->getCol() - 2) && isLegalCell(cells.at(3)->getRow() - 3, cells.at(3)->getCol() - 3)) {
			transferID(1, cells.at(1)->getRow() - 1, cells.at(1)->getCol() - 1);
			transferID(2, cells.at(2)->getRow() - 2, cells.at(2)->getCol() - 2);
			transferID(3, cells.at(3)->getRow() - 3, cells.at(3)->getCol() - 3);
		}
	}
